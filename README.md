...
- **OAuth 2.0 Playground**:
  ...
  - Authorize with `https://mail.google.com/` scope, exchange the authorization code for tokens, and note the "Refresh Token". If "Google hasn’t verified this app", then click "Advanced" > "Go to <yourappname>".
